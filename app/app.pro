...
win32 {
    ...
    LIBS += ws2_32.lib winmm.lib dxva2.lib ole32.lib gdi32.lib user32.lib d3d9.lib dwmapi.lib dbghelp.lib setupapi.lib bthprops.lib hid.lib libusb-1.0.lib advapi32.lib
